...
\newcommand{\likertfive}[2]{%
  \begin{tabular}{@{}ccccc@{}}
    \footnotesize 1 & \footnotesize 2 & \footnotesize 3 & \footnotesize 4 & \footnotesize 5 \\
    $\bigcirc$ & $\bigcirc$ & $\bigcirc$ & $\bigcirc$ & $\bigcirc$ \\[2pt]
    \multicolumn{2}{l}{\footnotesize #1} & & \multicolumn{2}{r}{\footnotesize #2}
  \end{tabular}%
}
...
\begin{tabularx}{\textwidth}{@{} p{0.44\textwidth} X p{4.2cm} @{}}
\toprule
\textbf{情境} & \textbf{甲 是否屬於盜版？} & \textbf{乙 應否被允許？} \\
\midrule
